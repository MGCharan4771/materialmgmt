		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#materialmgmt-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"materialmgmt-display": {
								"semanticObject": "materialmgmt",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=materialmgmt",
									"url": sap.ui.require.toUrl("materialmgmt")
								}
							}
						}
					}
